;;; doom-beach-dark-theme.el --- ported from VSCode Horizon -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: January 21, 2020 (#374)
;; Author: Diviyan <https://github.com/diviyan>
;;
;;; Commentary:
;;; Code:
...
(defgroup doom-beach-dark-theme nil
  "Options for the `doom-beach-dark' theme."
  :group 'doom-themes)

(defcustom doom-beach-dark-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-beach-dark-theme
  :type 'boolean)

(defcustom doom-beach-dark-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-beach-dark-theme
  :type 'boolean)

(defcustom doom-beach-dark-comment-bg doom-beach-dark-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'doom-beach-dark-theme
  :type 'boolean)

(defcustom doom-beach-dark-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-beach-dark
                "A port of the port of the Visual Studio Code theme Horizon"

                ;; name       default    256       16
                ;;((bg         '("#121943" nil       nil            ))
                ((bg         '("#1F2339" nil       nil            ))
                 (bg-alt     '("#191c2b" nil       nil            ))
                 ;;(bg-alt     '("#171d3c" nil       nil            ))
                 ...
                 (fg-alt     '("#e3ddcd" "#fdf0ed" "brightwhite"  ))
                 (fg         '("#d7ccaf" "#c7c9cb" "white"        ))
                 ...
                 (selection      violet)
                 (builtin        violet)
                 (comments       (if doom-beach-dark-brighter-comments magenta hor-highlight-bright))
                 (doc-comments   yellow)
                 (constants      orange)
                 (functions      teal)
                 (keywords       violet)
                 ...
                 (-modeline-bright doom-beach-dark-brighter-modeline)
                 (-modeline-pad
                  (when doom-beach-dark-padded-modeline
                    (if (integerp doom-beach-dark-padded-modeline) doom-beach-dark-padded-modeline 4)))
  ...
  ;;;; Base theme face overrides
                (((font-lock-comment-face &override)
                  :slant 'italic
                  :background (if doom-beach-dark-comment-bg (doom-lighten bg 0.03) 'unspecified))
...
;;; doom-beach-dark-theme.el ends here
